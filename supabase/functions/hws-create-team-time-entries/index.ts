...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const supabaseUser = createClient(supabaseUrl, supabaseAnonKey, { db: { schema: "hws" },
    ...
    if (body.entries) {
      ...
      const supabaseAdminEarly = createClient(supabaseUrl, supabaseServiceKey, { db: { schema: "hws" } });
    ...
    const supabaseAdmin = createClient(supabaseUrl, supabaseServiceKey, { db: { schema: "hws" } });

...
function buildHtml(invoice: any, items: any[], bank: { kontoinhaber: string; iban: string; bic: string } = { kontoinhaber: "Gottfried Tilger", iban: "AT61 2081 5000 0423 1474", bic: "STSPAT2GXXX" }): string {
...
serve(async (req) => {
  ...
  try {
    ...
    // Load bank settings
    const bankData = { kontoinhaber: "Gottfried Tilger", iban: "AT61 2081 5000 0423 1474", bic: "STSPAT2GXXX" };
    ...
    const html = buildHtml(invoice, items || [], bankData);
